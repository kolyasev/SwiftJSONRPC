...
public class HTTPRequestExecutor: RequestExecutor {
    ...
    public var requestRetrier: HTTPRequestRetrier?
    ...
    private func dispatch(httpResponse: HTTPResponse, forRequest request: HTTPRequest, tasks: [RPCTask]) {
        do {
            ...
            default:
                throw HTTPResponseSerializationError(
                    cause: HTTPResponseSerializationError.UnexpectedPayloadTypeError(payload: payload)
                )
            }
